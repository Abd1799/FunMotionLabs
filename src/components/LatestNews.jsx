...
const LatestNews = () => {
  return (
    <div className="md:flex justify-between mt-10 sm:ml-10 sm:mr-5">
      <div className="md:block hidden items-center text-left pt-28 pl-32">
      ...
      <div className="h-fit text-left md:w-1/2 w-full rounded-lg object-cover object-center shadow-xl shadow-blue-gray-900/50 mr-20 mb-20">
